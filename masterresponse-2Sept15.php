...
//  <REQUEST>
//   <NAME>Product</NAME>
//   <FRANCHISEECODE>408456</FRANCHISEECODE>
//   </REQUEST>
// </ENVELOPE>";
...
/*  $getdata="<ENVELOPE>
  <REQUEST>
   <NAME>PGroup</NAME>
   <FRANCHISEECODE>000003</FRANCHISEECODE>
   </REQUEST>
 </ENVELOPE>"; */
...
/*   $getdata="<ENVELOPE>
 ...
 <REQUEST>
  ...
  <DOWNLOADEDPURCHASEVOUCHERS>PI/33~PI/2015-16~</DOWNLOADEDPURCHASEVOUCHERS>
  <FRANCHISEECODE>000003</FRANCHISEECODE>
 </REQUEST>
</ENVELOPE>"; */
...
/* $getdata="<ENVELOPE>
 <REQUEST>
   <NAME>Purchase Invoice is Created Successfully</NAME>
   <FRANCHISEECODE>000003</FRANCHISEECODE>
 </REQUEST>
</ENVELOPE>"; 
*/
	...
	$xml_object = simplexml_load_string( $HTTP_RAW_POST_DATA );      
			...
			if($request_person_name=="Product Group is Created Successfully")
			{
						...
						$taxtable4='productgroupupload'; 
						  ...
						  $post1c4['Status']='2';
						$wherecon= "PrimaryFranchise ='".$FRANCHISECODE."' ";
 ...
 */
	...
	if( $request_person_name=="PGroup")
	{
			...
			//$result="SELECT * FROM productgroupmaster a WHERE   NOT EXISTS(SELECT  null FROM productgroupupload d WHERE d.Status=2 and d.Code= a.ProductCode and d.PrimaryFranchise='".$FRANCHISECODE."') ";
			...
			$productgrplist =$productgrplist.$secdis_code."!".$ProductCode."!".$ProductGroup."!".$Parent."^";
			}
			//echo $productgrplist;
	...
	if($request_person_name=="Product")
	{
		...
		//$resultproduct="SELECT * FROM productmaster_view  a WHERE   NOT EXISTS(SELECT  null FROM productmasterupload d WHERE d.Status=2 and d.Code=a.ProductCode and d.Franchiseecode='".$FRANCHISECODE."')";
                $resultproduct="SELECT a.* FROM productmaster_view  a left join productmasterupload d on d.Code=a.ProductCode WHERE d.Status!=2 and d.PrimaryFranchise='".$FRANCHISECODE."'";
