...
<title><?php echo $_SESSION['title']; ?> || Retailer Master</title>
</head>
            ...
            <div style="width:930px; height:auto;   padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
              ...
              <!-- main row 1 start-->     
                ...
                <div style="width:1000px; height:60px; float:left; margin-left:8px; margin-top:-5px;">
						  ...
						  <input name="Search" id="Search" type="submit" class="button" value="Search">
				           </div>
    ...
    if(($row['editrights'])=='Yes') 
	 ...
	 ?>
	  ...
	  ?><?php */?>
              ...
              <td  bgcolor="#FFFFFF">
              <?=$record['Category']/*$p=mysql_query("SELECT RetailerCategory FROM retailercategory where CategoryCode='".$record['Category']."'");
			...
			echo $r['RetailerCategory'];*/ ?>
              ...
              <td  bgcolor="#FFFFFF">
              <?=$record['retailerclassification']?>
              </td>
              <td  bgcolor="#FFFFFF">
              <?=$record['geographical']?>
              </td>
              <td  bgcolor="#FFFFFF">
              <?=$record['retailercategory1']?>
              </td>
              <td  bgcolor="#FFFFFF">
              <?=$record['retailercategory2']?>
              </td>
              <td  bgcolor="#FFFFFF">
              <?=$record['retailercategory3']?>
              </td>
    </tr>
