...
$table .= '"Region Code","Region Name","Branch Code","Branch Name","Franchise Code","Franchise Name","MonthYear","Product Type Code","Product Type Name","Target",';
$table .="\n"; 
...
// Download the file
$filename = "Franchisee Target-".date('Y-m-d').".csv";
