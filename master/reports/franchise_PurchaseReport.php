...
//This block to authenticate the user whether he has the rights to access this page 
  $pagename = "GUI Purchase Report Based on Distributor Name";
...
unset($_SESSION['form_controls']);
    ...
    <script type="text/javascript">
        document.location='franchise_PurchaseReport.php';
    </script>
    <?
}
...
<title>SSV&nbsp;|&nbsp;GUI Purchase Report</title>
</head>
...
<input type="text" name="curdate" id="curdate" value="<?php echo date('Y-m-d'); ?>" />
                    ...
                    <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
                        ...
                        <div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>GUI Purchase Report Based on Distributor Name</p>
                        </div>
                   ...
                   <? if (($authen_row['usertype'])== 'Others') { 
                                ...
                                <div style="float:left;width:400px">
                                   <div style="width:145px; height:30px; float:left; margin-top:5px; margin-left:3px;">
                                    ...
                                    <div style="width:190px; height:auto;  float:left;  margin-top:5px; margin-left:3px;">
                                        ...
                                        <input type="hidden" name="SRP_FromDate"  style="width:90%;height: inherit;"  id="rp_frdate" value="<?php echo $_POST['SRP_FromDate']; ?>"/>
                                    </div>
                    ...
                    <input type="text" name="SRP_ToDate" id="todate" style="width:90%;height: inherit;" readonly="readonly" value="<?php echo $_POST['SRP_ToDate']; ?>" />
                                     ...
                                     <? if (($authen_row['usertype'])== 'Others') { 
                                      ...
                                      ?>  
                                       <div style="width:145px; height:30px; float:left; margin-top:20px; margin-left:3px;">
                                        <label>Chart Types</label><label style="color:#F00;">*</label>
                                    </div>
                                    <div style="width:190px; height:30px;  float:left;  margin-top:20px; margin-left:3px;">
...
?>
				...
				// Log information
					...
					weblogfun("Report Access", "GUI Reports -> ".$pagename);
                  // foreach ($_POST['franchise'] as $selectedOption2){
                  //   if($selectedOption2!="0")
                  //   {
                  //   $fname =  "franchisename = '" .$selectedOption2."'";
                  //   $dis_franchisename = $selectedOption2;
                  //   $gui_query = "SELECT pgroupname,productcode,sum(quantity) as quantity FROM `r_purchasereport` where  $fname ";
                   ...
                   $reg = substr($reg, 0, -3);
                     ...
                     if($reg!=NULL)
                      ...
                      if($pcode!=NULL)
                      {
                        ...
                        $gui_query = "SELECT pgroupname,productcode,sum(quantity) as quantity FROM `r_purchasereport` where $grystrres ";
                        $group_by = "productcode"; ?>
                        <script language="javascript">
                    var chart_type = <?php echo json_encode($_REQUEST['chart_types']); ?>;
                    </script> 
                  ...
                  if($_POST['SRP_FromDate']!="" && $_POST['SRP_ToDate']!="")
                  {
                    ...
                    $dbfromdatefrom=date('Y-m-d',strtotime($_POST['SRP_FromDate']));
                      if($gui_query!=NULL && $group_by!=NULL)
                      {
                         ...
                         $gui_query = $gui_query." AND  purchasedate between $dbfromdatefrom AND $dbtodateto group by $group_by";
                          //echo $gui_query;
                         $gui_result = mysql_query($gui_query);
                         $numrows = mysql_num_rows($gui_result);
                         $dis_franchisename = "GUI Purchase Report for ".$dis_franchisename;
                         ...
                         if($numrows== 0){ ?>
                          ...
                          $chart['cols'] = array(
                           ...
                           while ($row_list = mysql_fetch_assoc($gui_result)) {
                              ...
                              $temp[] = array('v' => (string) $row_list[$group_by]); 
