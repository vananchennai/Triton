...
{
	header('Location:Export_psummary.php');
	echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_psummary.php">';
	exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='PurchaseSummary.php';
    </script>
    <?
                            ...
                            <table align="center" bgcolor="#ffffFF" border="1" width="900px" cellpadding="20%">
								...
								$grystrres = substr($grystr, 0, -4);
									if($_POST['PS_FromDate']!="" && $_POST['PS_ToDate']!="")
									{
										...
										$qry ="CALL r_purchasesummary($dbfromdatefrom,$dbtodateto,$grystrres);";
