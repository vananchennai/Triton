...
//This block to authenticate the user whether he has the rights to access this page 
	$pagename = "Reach Report";
	require_once 'Authentication_Rights.php';
	// Authentication block ends 
		
	// Export function 
if (isset($_POST['Excel'])) {
	header('Location:Export_ReachReport.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_ReachReport.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='ReachReport.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Reach Report</title>
				...
				<div style="float:left;width:400px">
                  ...
                  if($dsr!=NULL)
                  {
                    $grystr=$grystr. "(".$dsr.") AND ";
								...
								$qry ="CALL r_reachreport($dbfromdatefrom,$dbtodateto,$grystrres);";
