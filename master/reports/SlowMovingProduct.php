...
unset($_SESSION['form_controls']);
    ...
    <script type="text/javascript">
        document.location='SlowMovingProduct.php';
    </script>
    <?
}
if (isset($_POST['Excel'])) 
{
  ...
  $_SESSION['filename'] = 'SlowMovingProduct-';
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Slow Moving Product Report</title>
</head>
           ...
           <? require_once'all_list.php' ?>
                    <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
                        ...
                        <div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>Slow Moving Product Report </p>
                        </div>
