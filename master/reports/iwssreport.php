...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='iwssreport.php';
    </script>
    <?
}
                                ...
                                if (isset($_POST['Get'])) 
								{
									...
									if($_POST['SRP_FromDate']!="" && $_POST['SRP_ToDate']!="")
									{
										...
										$dbfromdatefrom=date('Y-m-d',strtotime($_POST['SRP_FromDate']));
											...
											if($frnfil!=NULL)
											{
												$frnfil= str_replace("pd_code","PrimaryFranchise",$frnfil);
												$frnfil= str_replace("franchisecode","Franchisecode",$frnfil);
										...
										$qry ="CALL r_iwssreport($dbfromdatefrom,$dbtodateto,$grystrres,$frnfil);";
