...
//This block to authenticate the user whether he has the rights to access this page 
	$pagename = "Day Wise Synch Status - Master Upload";
	require_once 'Authentication_Rights.php';
	// Authentication block ends 
		
	// Export function 
if (isset($_POST['Excel'])) {
	header('Location:Export_DaywiseSyncUploadReport.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_Export_DaywiseSyncUploadReport.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='daywiseupload.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Day Wise Synch Status - Master Upload</title>
            ...
            <div style="width:950px; height:auto; float:left; margin-bottom:10px; margin-left:15px;" id="center">  
                ...
                <form method="POST" action="<?php // $_PHP_SELF          ?>">
					...
					<div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>Day Wise Synch Status - Master Upload</p>
                        </div>
				...
				<div style="float:left;width:400px">
                  ...
                  if($fname!=NULL)
                  {
                    $grystr=$grystr. "(".$fname.") AND ";
								...
								$qry ="CALL r_ddsynupload($dbfromdatefrom,$dbtodateto,$grystrres);";
