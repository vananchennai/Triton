...
//This block to authenticate the user whether he has the rights to access this page 
	$pagename = "Month Wise Synch Status - Transaction Download";
	require_once 'Authentication_Rights.php';
	// Authentication block ends 
		
	// Export function 
if (isset($_POST['Excel'])) {
	header('Location:Export_MonthlySyncStatusDloadReport.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_MonthlySyncStatusDloadReport.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='monthlysyncdload.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Monthly Sync status Download Report</title>
            ...
            <div style="width:950px; height:auto; float:left; margin-bottom:10px; margin-left:15px;" id="center">  
                ...
                <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
					<div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>Monthly Sync status Download Report</p>
                        </div>
				...
				<div style="float:left;width:400px">
                  ...
                  if(isset($_POST['franchise'])) 
                  {
                    ...
                    foreach ($_POST['franchise'] as $selectedOption2){
                      ...
                      {
                        $fname = $fname . "v.Franchisecode = '" .$selectedOption2."'  OR ". "\n";
                      }else{
                          $fname = $fname1;
                          break;
                      }
                  ...
                  if($fname!=NULL)
                  {
                    $grystr=$grystr. "(".$fname.") AND ";
								...
								$qry ="CALL r_mmsyncdload($dbfromdatefrom,$dbtodateto,$grystrres);";
