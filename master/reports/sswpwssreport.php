...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Distributor Wise Product Wise Stock Summary-(Sales Summary report) </title>
            ...
            <div style="width:950px; height:auto; float:left; margin-bottom:10px; margin-left:15px;" id="center">  
                ...
                <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
					<div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>Distributor Wise Product Wise Stock Summary-(Sales Summary report)</p>
                        </div>
                           ...
                           <table align="center"  bgcolor="#ffffFF" border="1" width="900px" cellpadding="20%">
                                ...
                                if (isset($_POST['Get'])) 
								{
									...
									foreach ($_POST['Productgroup'] as $selectedOption5){
										...
										{
										$pgrp =  $pgrp. "pgroupname = '" .$selectedOption5."'  OR ". "\n";  
										}
									...
									if($_POST['SRP_FromDate']!="" && $_POST['SRP_ToDate']!="")
									{
										...
										$dbfromdatefrom=date('Y-m-d',strtotime($_POST['SRP_FromDate']));
											...
											if($pgrp!=NULL)
											{
												...
												$pgrp= "'".$pgrp."'";
												// $ptype = str_replace("r.pgroupname","ProductCode",$pgrp);
											    $pgrp= str_replace("pgroupname","ProductCode",$pgrp);
										...
										$qry ="CALL r_sswpwssreport($dbfromdatefrom,$dbtodateto,$grystrres,$pgrp);";
