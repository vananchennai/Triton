...
{
    header('Location:Export_PurchaseReturn.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_PurchaseReturn.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) 
{
   ...
   ?><script type="text/javascript"> document.location='PurchaseReturn.php';</script><?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Purchase Returns</title>
</head>
                            ...
                            <table align="center" border="1" width="900px" cellpadding="20%"  bgcolor="#ffffFF">
                                ...
                                <tr class="record_header" style="white-space:nowrap;">
                                    ...
                                    <td style="font-weight:bold; width:auto; text-align:center;">Distributor  Name</td>
									  <td style="font-weight:bold; width:auto; text-align:center;">Purchase Return Number</td>
									   <td style="font-weight:bold; width:auto; text-align:center;">Purchase Return Date</td>
								...
								*/	
									...
									*/		
									...
									if($_POST['PS_FromDate']!="" && $_POST['PS_ToDate']!="")
									{
										...
										$qry ="CALL r_purchasereturns($dbfromdatefrom,$dbtodateto,$grystrres);";
								...
								// Log information
									...
									for($i=$startpoint;$i<$limit+$startpoint;$i++)
									{
										...
										{
											$podate='';
											if($record[$i]['purchaseRetdate'] != NULL)
											{
												$podate = date('d-m-Y',strtotime($record[$i]['purchaseRetdate'])) ;
											}
											...
											echo '<td>' . $record[$i]['purchaseRetnumber'] . '</td>';
											echo '<td>' . $podate . '</td>';
