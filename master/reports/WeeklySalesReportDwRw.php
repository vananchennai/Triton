...
//This block to authenticate the user whether he has the rights to access this page 
	$pagename = "WeeklySalesReportDwRw";//WeeklySalesReportDwRw
	require_once 'Authentication_Rights.php';
	// Authentication block ends 
		
	// Export function 
if (isset($_POST['Excel'])) {
	header('Location:Export_WeeklySalesReportDwRw.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_WeeklySalesReportDwRw.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='WeeklySalesReportDwRw.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Dealers Sales Report-Week wise SKUwise</title>
            ...
            <div style="width:950px; height:auto; float:left; margin-bottom:10px; margin-left:15px;" id="center">  
                ...
                <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
					<div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>Dealers Sales Report-Week wise SKUwise</p>
                        </div>
				...
				<div style="float:left;width:400px">
                  ...
                  if($dsr!=NULL)
                  {
                    $grystr=$grystr. "(".$dsr.") AND ";
								...
								$qry ="CALL r_weeklysalesreport($dbfromdatefrom,$dbtodateto,$grystrres);";
