...
//This block to authenticate the user whether he has the rights to access this page 
	...
	{
		header("location:branch_SalesReport.php");
	}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Sales Report</title>
</head>
                            ...
                            <table align="center" border="1" cellpadding="20%"  bgcolor="#ffffFF">
                                ...
                                if (isset($_POST['Get'])) 
								{
									...
									if($_POST['SRP_FromDate']!="" && $_POST['SRP_ToDate']!="")
									{
										...
										$qry ="CALL r_salesreport($dbfromdatefrom,$dbtodateto,$grystrres);";
								...
								// Log information
									...
									for($i=$startpoint;$i<$limit+$startpoint;$i++)
									{
										...
										{
											$salesdate='';
											if($record[$i]['salesdates'] != NULL)
											{
												$salesdate = date('d-m-Y',strtotime($record[$i]['salesdates'])) ;
											}
