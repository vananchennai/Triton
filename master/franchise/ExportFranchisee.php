...
function FancyTable($header, $data,$header2)
{
    ...
    $this->SetFont('','B');
    // Header
    $width = array(13,30,23,12,40,10,18,16,30,20,15,15,15,15,15);
    ...
    foreach($data as $row)
    {
		...
		$this->Cell($width[13],6,$row[14],'LR',0,'L',$fill);
        $this->Ln();
        $fill = !$fill;
    }
    // Closing line
...
$header = array('Primary','Distributor', 'Distributor', 'Contact', 'Designation', 'Address' ,'Pincode' ,'Tel.No','Mob.No','Email','Branch','State','Region','Tin No','Cst No');
$header2 = array('Distributor','Code', 'Name','Person','','','','','','','','','','','');
...
<tr border='2' align='center' bgcolor='#CCCCCC' style='width:150px; bordercolor;#FF0000; height:30px;font-weight:bold;'>
	<td colspan='17' align='center' border='1'  style='height:40px; bordercolor:#FF0000; font-weight:50px;'>J.K. Fenner (India) Limited</td>
	</tr>
	<tr border='2'  align='center' bgcolor='#CCCCCC' style='width:150px; bordercolor;#FF0000; height:30px;font-weight:bold;'>
	<td colspan='17' align='center' border='1'  style='height:30px; bordercolor:#FF0000; font-weight:50px;'>Distributor Master</td>
	</tr>
	<tr border='2' align='center' bgcolor='#CCCCCC' style='width:150px; bordercolor;#FF0000; height:30px;font-weight:bold;'>
	<td align='center' bgcolor='#CCCCCC' style='width:150px; bordercolor;#FF0000; height:30px;font-weight:bold;'>Primary Distributor</td>
	...
	<td align='center' style='width:200px; height=30px; bordercolor=#000000;'>".$myrecord[16]."</td>
	</tr>";
}
echo $table;
