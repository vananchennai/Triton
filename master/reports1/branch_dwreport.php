...
if (isset($_POST['Excel'])) {
	header('Location:Export_dwreport.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_dwreport.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='branch_dwreport.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Division Wise Sales Summary Report </title>
            ...
            <div style="width:950px; height:auto; float:left; margin-bottom:10px; margin-left:15px;" id="center">  
                ...
                <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
					<div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>Division Wise Sales Summary Report</p>
                        </div>
						   ...
						   <select name='Period' id="Period" onChange="datefun();">
							  ...
							  <div style="width:145px; height:30px; float:left; margin-top:6px; margin-left:45px;">
    							...
    							<div style="width:145px; height:30px; float:left; margin-top:5px; margin-left:45px;">
                                    ...
                                    <div style="width:190px; height:auto;  float:left;  margin-top:5px; margin-left:3px;">
                                        <select name='Producttype[]' id="Producttype" multiple="multiple" onChange="allProducttype();">
							 ...
							 <td style="font-weight:bold; width:auto; text-align:center;">Product Segment</td>  
								...
								if(isset($_POST['franchise'])) 
									...
									if($_POST['SRP_FromDate']!="" && $_POST['SRP_ToDate']!="")
									{
										...
										$qry ="CALL r_dwreport($dbfromdatefrom,$dbtodateto,$grystrres,$fname);";
