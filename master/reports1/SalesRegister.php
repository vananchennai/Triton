...
if (isset($_POST['Excel'])) {
	header('Location:Export_SRegister.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_SRegister.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='SalesRegister.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Sales Register </title>
                           ...
                           <table align="center"  bgcolor="#ffffFF" border="1" width="900px" cellpadding="20%">
								...
								if(isset($_POST['branch'])){
									...
									if($_POST['SRP_FromDate']!="" && $_POST['SRP_ToDate']!="")
									{
										...
										$qry ="CALL r_salesregister($dbfromdatefrom,$dbtodateto,$grystrres);";
