                    ...
                    <?
                                   ...
                                   <div style="width:145px; height:30px; float:left; margin-top:5px; margin-left:3px;">
                                    ...
                                    <div style="width:190px; <? echo $height; ?>  float:left;  margin-top:5px; margin-left:3px;">
                                        <select <? echo $style_height ; ?> <? echo $div_style; ?> name='primaryfranchise[]' id='primaryfranchise' <? echo $multiple; ?> onChange="drpfranchise();" <? //echo $onchange;?> >
                                  ...
                                  <? } ?>
                                    ...
                                    <div style="width:190px; height:auto;  float:left;  margin-top:5px; margin-left:3px;">
                                        <select name='RetailerCategory[]' id = 'RetailerCategory' multiple="multiple" onchange="allretailercategory();" >
