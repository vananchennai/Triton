...
//This block to authenticate the user whether he has the rights to access this page 
	$pagename = "Zone State Sales Summary";
	...
	{
		header("location:zsssreport.php");
	} 
	// Authentication block ends 
		
	// Export function 
if (isset($_POST['Excel'])) {
	header('Location:Export_zsssreport.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_zsssreport.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='zsssreport.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;Zone Wise State Wise Sales Summary </title>
            ...
            <div style="width:950px; height:auto; float:left; margin-bottom:10px; margin-left:15px;" id="center">  
                ...
                <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
					<div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>Zone Wise State Wise Sales Summary</p>
                        </div>
						   ...
						   <select name='Period' id="Period" onChange="datefun();">
							  ...
							  <div style="width:145px; height:30px; float:left; margin-top:5px; margin-left:45px;">
								 ...
								 <div style="width:145px; height:30px; float:left; margin-top:5px; margin-left:45px;">
									...
									<select name='region[]' id='region' onChange="allregion();" multiple="multiple" >
                  ...
                  <div style="width:930px; height:60px; float:left; margin-left:8px; margin-top:8px;">
                       ...
                       <div style="width:917px; <?php echo $table_data_height ?> padding-bottom:8px; margin-top:20px; float:left; margin-left:10px; overflow:auto;" class="grid">
                                ...
                                if (isset($_POST['Get'])) 
								{
									...
									foreach ($_POST['state'] as $selectedOption6){
										if($selectedOption6!="0")
										{
										$sta =  $sta. "v.statename = '" .$selectedOption6."'  OR ". "\n";
										}
									}
									$reg =	substr($reg, 0, -4);
									$sta =	substr($sta, 0, -4);
								...
								$qry ="CALL r_zsssreport($dbfromdatefrom,$dbtodateto,$grystrres);";
