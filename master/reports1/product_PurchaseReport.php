...
//This block to authenticate the user whether he has the rights to access this page 
  $pagename = "GUI Purchase Report Based on Products";
...
unset($_SESSION['form_controls']);
    ...
    <script type="text/javascript">
        document.location='product_PurchaseReport.php';
    </script>
    <?
}
...
<title>SSV&nbsp;|&nbsp;GUI Sales Report</title>
</head>
...
<input type="text" name="curdate" id="curdate" value="<?php echo date('Y-m-d'); ?>" />
                    ...
                    <div style="width:930px; height:auto;   min-height: 180px; padding-bottom:8px; margin-top:8px; float:left; margin-left:10px;">
                        ...
                        <div style="width:930px; height:25px; float:left;  margin-left:0px;" class="head">
                            <p>GUI Purchase Report Based on Products</p>
                        </div>
                   ...
                   $reg = substr($reg, 0, -3);
                     ...
                     if($reg!=NULL)
                      ...
                      if($pcode!=NULL)
                      {
                        ...
                        $gui_query = "SELECT franchisename,sum(quantity) as quantity FROM `r_purchasereport` where $grystrres ";
                    ...
                    $dbfromdatefrom=date('Y-m-d',strtotime($_POST['SRP_FromDate']));
                      if($gui_query!=NULL && $group_by!=NULL)
                      {
                        ...
                        // echo $gui_query;
                         ...
                         $dis_productcode = "GUI Purchase Report for ".$dis_productcode;
                         echo $dis_productcode;
                         if($numrows== 0){ ?>
                              <script type="text/javascript">
                                        alert("No data Available",'product_PurchaseReport.php');
                                        </script>
                          <? exit;
                         }
                          $rows = array();
                          ...
                          $chart['cols'] = array(
                            ...
                            */
                            array('label' =>  $dis_productcode , 'type' => 'string'),
