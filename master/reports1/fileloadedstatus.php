...
if (isset($_POST['Excel'])) {
	header('Location:Export_fileloadedstatus.php');
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=Export_fileloadedstatus.php">';
    exit;
}
...
if (isset($_POST['Cancel'])) {
    ...
    <script type="text/javascript">
        document.location='fileloadedstatus.php';
    </script>
    <?
}
...
<title><?php echo $_SESSION['title']; ?> |&nbsp;File Loaded Status </title>
                       ...
                       <div style="width:917px; <?php echo $table_data_height ?> padding-bottom:8px; margin-top:20px; float:left; margin-left:10px; overflow:auto;" class="grid">
                                ...
                                if (isset($_POST['Get'])) 
								{
									...
									if($_POST['SRP_FromDate']!="" && $_POST['SRP_ToDate']!="")
									{
										...
										$qry ="CALL r_fileloadedstatus($dbfromdatefrom,$dbtodateto,$uid);";
