 ...
 $tname = "userrights";
 	...
 	if (($row['viewrights'])== 'No')
	{
		?>
			...
			alert("you are not allowed to view this page..!!");	document.location='/ARBLTCS/home/home/master.php';
			</script>
         <?
	}
...
//user is logged in
		 ...
		 if (preg_match('/[0-9]/', $newpassword) && preg_match('/[a-z]/', $newpassword) && preg_match('/[A-Z]/', $newpassword))
		{
			...
			?>
		    <script type="text/javascript">
			alert("Password must have one special characters(-@#$%^&+=)...! Enter again",'firstloginpasschg.php');
			</script>
			<?
			}
			...
			?>
		    <script type="text/javascript">
			alert("Your Password has been changed successfully..!",'/SSV/home/home/master1.php');
			</script>
			<?
				//session_destroy();
		...
		else
		{
			?>
		    <script type="text/javascript">
			alert("Please follow the password rule",'firstloginpasschg.php');
			</script>
			<?
		}
		}
		...
		else
		{
			...
			?>
		    <script type="text/javascript">
			alert("Old and New passwords are same..! Enter again",'firstloginpasschg.php');
			</script>
			<?
			}	
		}
			...
			?>
		    <script type="text/javascript">
			alert("New and Repeat passwords are not the same..! Enter again",'firstloginpasschg.php');
			</script>
			<?
			}
			...
			?>
		    <script type="text/javascript">
			alert("Old Password doesn't match..! Enter again",'firstloginpasschg.php');
			</script>
			<?
			}
		}
		...
		<div style="width:350px; height:130px; float:right;">
          ...
          <label><b>User :</b><? echo $_SESSION['username'].' ['.$_SESSION['employeeusername'].']';?></label>
            ...
            <div style="width:340px; height:30px;  float:left;  margin-top:2px; margin-left:8px;" class="contval">
             <div id='csslogout'> <ul> <li>  <a href="/ARBLTCS/logout.php"><b>Logout</b></a> </li> </ul>  </div>
               </div>
         </div>
