    ...
    public function queryString_handler($xml_path) {
        ...
        if(isset($this->arrayParameter)) {
            foreach($this->arrayParameter as  $v => $a) {
				...
				//$this->sql = str_replace('$P{'.$v.'}', "HML001", $this->sql);
            }
        }
    }
...
//        $this->pointer[]=array("type"=>"MultiCell","width"=>$data->reportElement["width"],"height"=>$height,"txt"=>$data->text,"border"=>$border,"align"=>$align,"fill"=>$fill,"hidden_type"=>"statictext","soverflow"=>$stretchoverflow,"poverflow"=>$printoverflow,"rotation"=>$rotation);
	...
	//$AA="C:\\xampp\\htdocs\SSV\\img\\search.jpg";//C:\xampp\htdocs\SSV\Barcode\BarCode.jpeg";
         $imagepath=$data->imageExpression;
		// $imagepath=$data->"C:\\xampp\\htdocs\SSV\\img\\search.jpg";//imageExpression;
	//$imagepath="http://localhost:81/tcpdf_min/barcode.php";
	
		// $imagepath= $data->$AA;//"C:\xampp\htdocs\SSV\Barcode\BarCode.jpeg";
        //$imagepath= substr($data->imageExpression, 1, -1);    C:\xampp\htdocs\SSV\img\search.jpg
